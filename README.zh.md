...
### [我的博客在这里 &rarr;](http://2life.github.io)
...
```
# Site settings
title: Blog2life             # 你的博客网站标题
SEOTitle: Hdy Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: 2life     # 你的github账号
weibo_username: 2life      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-hdy.jpg     #你的大头贴，请使用绝对地址.
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/2life/2life.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“Hdy Blog”** 但是我想要在搜索的时候显示 **“黄永的博客 | Hdy Blog”** ，这个就需要SEO Title来定义了。
