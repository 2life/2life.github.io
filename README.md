...
###[View Live Blog2life &rarr;](http://2life.github.io)

![](http://www.2life.cc/img/blog-desktop.jpg)
...
```
$ git clone git@github.com:2life/2life.github.io.git
```

**[View Boilerplate Here &rarr;](http://www.baidu.com)**


## Translation

 - ![cn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **Chinese (Simplified)**: 感谢 [@BrucZhaoR](https://github.com/BruceZhaoR) 的 [中文翻译 &rarr;](https://github.com/2life/2life.github.io/blob/master/README.zh.md)
...
- Fixed [issue#15](https://github.com/2life/2life.github.io/issues/15) about code wrap.
...
```
# Site settings
title: Blog2life             # title of your website
SEOTitle: Blog2life			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: 2life     # modify this account to yours
weibo_username: 2life      # the footer woule be auto-updated.
...
![](http://www.life.cc/img/blog-sidebar.jpg)
...
sidebar-avatar: /img/avatar-hdy.jpg     # use absolute URL.
```
...
Change header images of any pages or any posts is pretty easy as mentioned above. But, thanks to [issue #6 (in Chinese)](https://github.com/2life/2life.github.io/issues/6) asked, **how to make it looks great?**
...
It's possible that you want the two things different. For me, my site-title is **“Hdy Blog”** but I want the title shows in search engine is **“黄永的博客 | Hdy Blog”** which is multi-language.
